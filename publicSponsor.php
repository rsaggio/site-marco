		...
		<div class="container-wrapper">
			...
			<div class="select-group">
				...
				<fieldset class="investmentType-fieldset">
					...
					<div class="signupForm-fieldsetReplacer fieldsetReplacer-publicSponsor">
						
						<input id="investmentType-funding" class="somePublicProject-information-button investmentType-funding" type="radio" 
						name="somePublicProject-information" value="greenfield">
						<label class="signupForm-button" for="investmentType-funding">Greenfield</label>

						<input id="investmentType-sponsoring" class="somePublicProject-information-button investmentType-sponsoring" type="radio" 
						name="somePublicProject-information" value="brownfield"> 
						<label class="signupForm-button" for="investmentType-sponsoring">Brownfield</label>

						<input id="investmentType-volunteering" class="somePublicProject-information-button investmentType-volunteering" type="radio" 
						name="somePublicProject-information" value="mix">
				...
				<fieldset class="investmentType-fieldset">
					...
					<div class="signupForm-fieldsetReplacer fieldsetReplacer-publicSponsor">
						...
						<input id="financingType-borrow" class="somePublicProject-information-button financingType-funding" type="radio" 
						name="financingType" value="borrow" checked>
						<label class="signupForm-button" for="financingType-borrow">Borrow</label>

						<input id="financingType-refinance" class="somePublicProject-information-button financingType-sponsoring" type="radio" 
						name="financingType" value="refinance"> 
						<label class="signupForm-button" for="financingType-refinance">Refinance</label>

						<input id="financingType-mezzanine" class="somePublicProject-information-button financingType-volunteering" type="radio" 
			...
			<button class="signupForm-button publicSponsor-submit" type="submit">Submit</button>
